---
title: 给博客添加个充电按钮（仿B站）
tags:
  - html
  - 仿B站
categories: 网络技巧
cover: https://cdn2.tianli0.top/gh/timigomen/cdn/img/20230107101346.png
top_img: https://cdn2.tianli0.top/gh/timigomen/cdn/img/20230107101346.png
abbrlink: 2bb25fcf
date: 2023-1-7 07:40:56
---
![](https://cdn2.tianli0.top/gh/timigomen/cdn/img/20230107091401.png)
...
.i-pin-cover,.i-pin-part:hover .i-pin-info .btn-container {
    display: block;
}
...
.i-pin-has-content.disabled .disabled-cover {
    display: block;
    line-height: 175px;
}
...
#i-masterpiece .small-item .cover,#i-masterpiece .small-item .cover img {
    width: 220px;
    height: 138px;
}

#i-masterpiece .small-item .disabled-cover {
    line-height: 135px;
}
...
#page-index .channel .channel-item.vertical .small-item .cover {
    float: left;
}
...
#page-index .subs .cover img {
    background-image: url(//s1.hdslb.com/bfs/static/jinkela/space/assets/tag-default-cover.png);
}
...
#page-index .fav-item[data-count="0"] .fav-cover-placeholder {
    border-radius: 2px;
...
#page-index .fav-item[data-count="1"] .fav-cover-0 {
    border-radius: 2px;
    height: 152px;
}

#page-index .fav-item[data-count="2"] .fav-cover-1 {
...
.h .avatar-container:hover .avatar-cover {
    opacity: 1;
}
...
# 然后就是图片素材了（我直接从B站八的）
![](https://gitlab.com/KINGWDY/photobed/-/raw/main/icons.png)
![](https://gitlab.com/KINGWDY/photobed/-/raw/main/charging_focus.gif)
![](https://gitlab.com/KINGWDY/photobed/-/raw/main/charging_hover.gif)
