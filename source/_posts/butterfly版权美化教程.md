---
title: butterfly版权美化教程
abbrlink: a0d6dfaf
swiper_index: 3
date: 2023-01-03 08:55:11
tags:
  - hexo 
  - butterfly
top_img: https://bj.bcebos.com/baidu-rmb-video-cover-1/012304f6579c69cebf02e9b0e889c574.png
cover: https://bj.bcebos.com/baidu-rmb-video-cover-1/012304f6579c69cebf02e9b0e889c574.png
categories: 魔改
---
# 前言
不知道大家对于默认的```butterfly```版权怎么看？反正我是觉得很丑。突然有一天我在洪哥的鱼塘发现了[小N同学的一篇文章](https://www.imcharon.com/117/)
# 效果
![原版](https://bj.bcebos.com/baidu-rmb-video-cover-1/3638502707011fce278543452233b3ab.png)
![改版](https://bj.bcebos.com/baidu-rmb-video-cover-1/817e35c74e34716d0c185a184674e7eb.png)
# 教程
## 修改```post-copyright.pug```
打开```themes\butterfly\layout\includes\post```文件夹，将下列代码覆盖```post-copyright.pug```文件
```js
...
## 修改```post.styl```
打开```themes\butterfly\source\css_\layout```文件夹，修改```post.styl```文件
### 如果是4.5.1，可以直接替换我改好的
```css
beautify()
  headStyle(fontsize)
